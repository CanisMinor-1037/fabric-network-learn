...
export CORE_PEER_TLS_ROOTCERT_FILE=/home/kali/hyperledger/fabric-network-learn/crypto-config/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/tls/ca.crt
